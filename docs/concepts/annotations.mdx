...
See [Embedding Annotations guide](/docs/guides/embedding-annotations) for detailed implementation patterns including suggested severity colors and grouping strategies.
